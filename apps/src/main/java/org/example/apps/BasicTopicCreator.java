...
import org.example.core.admin.TopicCreateService;
...
@Slf4j
public class BasicTopicCreator extends AbstractCommand implements Runnable {
    ...
    @Getter
    @Option(names = {"--partition-cnt"}, description = "Number of partitions for each topic. Default: 1")
    ...
    private void initService() {
        ...
        List<IService> services = List.of(new TopicCreateService(
                brokers,
                prefix + "_deleter",
                prefix,
                partitionCnt,
