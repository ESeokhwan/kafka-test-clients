...
java -cp /home/huan99/kafka_test_clients/build/libs/kafka_test_clients-1.0-SNAPSHOT-all.jar org.example.BasicProducerWithMonitor localhost:9092 test_topic_ms_10000 -s 10000 -n 200000 -m output/cur/producer_monitor_cold.csv
