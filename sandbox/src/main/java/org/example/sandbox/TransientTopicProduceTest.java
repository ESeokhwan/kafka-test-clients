...
@Slf4j
public class TransientTopicProduceTest implements Runnable {
    ...
    public TransientTopicProduceTest() {
        super();
    }
        ...
        try (Producer<String, String> producer = new KafkaTransientTopicProducer<>(props)) {
            ...
            for (int i = 0; i < groupCount; i++) {
                ...
                for (int j = 0; j < perGroupCount; j++) {
                    ...
                    addMonitorLog(messageId, "Requested");
    ...
    public class BasicProducerCallback implements Callback {
        ...
        public void onCompletion(RecordMetadata metadata, Exception exception) {
            ...
            addMonitorLog(messageId, "Responded");
    ...
    public static void main(String[] args) {
        ...
        new CommandLine(new TransientTopicProduceTest())
                .execute(args);
    }
}
