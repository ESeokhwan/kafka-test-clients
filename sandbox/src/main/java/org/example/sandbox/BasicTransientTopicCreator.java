...
import org.example.sandbox.services.TransientTopicCreateService;
import picocli.CommandLine;
import picocli.CommandLine.Option;

@Slf4j
public class BasicTransientTopicCreator extends AbstractCommand implements Runnable {
    ...
    @Getter
    @Option(names = {"-p", "--prefix"}, required = true, description = "Prefix of topic names to be created")
    ...
    public BasicTransientTopicCreator() {
        super();
    }
    ...
    public static void main(String[] args) {
        ...
        new CommandLine(new BasicTransientTopicCreator())
                .execute(args);
    }
    ...
    private void initService() {
        ...
        List<IService> services = List.of(new TransientTopicCreateService(
                brokers,
                prefix + "_creator",
                prefix,
                startIndex,
