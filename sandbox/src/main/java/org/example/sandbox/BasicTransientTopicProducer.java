...
@Slf4j
public class BasicTransientTopicProducer extends AbstractCommand implements Runnable {
    ...
    public BasicTransientTopicProducer() {
        super();
    }
    ...
    public static void main(String[] args) {
        ...
        BasicTransientTopicProducer app = new BasicTransientTopicProducer();
